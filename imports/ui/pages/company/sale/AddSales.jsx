...
<div className="level-right">
    ...
    <label className="label">Note</label>
     ...
     <div className="field">
  <div className="control">
    <textarea className="textarea is-small" placeholder="Small textarea" defaultValue={""} />
  </div>
</div> </div>
</div>
       <hr className="solid" /> 
...
<hr className="solid" /><div className="level-right">
                  <div className="level-item">
<div className="table-container">
                  <table className="table is-bordered is-striped is-fullwidth">
                    <tbody>
                      <tr>
                      {info.map(({ name, sortable, field }) => (
                          <th
                            key={name}
                            onClick={() =>
                              handleSort(
