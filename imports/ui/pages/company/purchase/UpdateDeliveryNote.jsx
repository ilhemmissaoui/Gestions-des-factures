...
const UpdateDeliveryNote = () => {
    ...
    const getEstimateInfo = () => {
        Meteor.call('getSingleDelivery', id, (e, r) => {
            if (!e) {
                console.log(r);
                setEstimateInfo(r);
                setTotalInfo({
                    totalTHA: r.totalSum,
                    totalTVA: r.totalTVA,
                    totaleVTA: r.totaleVTA,
                    totaleTaxeIncl: r.totaleTaxeIncl,
                });
                let products = [];
                r.productList && r.productList.map(e => products.push(
                    {
                        imageUrl: "",
                        name: e.name,
                        quantity: e.quantity,
    ...
    const submitForm = (e) => {
        ...
        const data = {
            ...totalInfo,
            customer: pickedCustomer[0]?.fullName ?? estimateInfo?.supplier,
                                                                                    ...
                                                                                    <td className="mx-5">
                                                                                        <div className="field">
                                                                                            <input
                                                                                                ...
                                                                                                type="number"
                                                                                                name="quantity"
                                                                                                value={productListForm[i].quantity}
                                                                                                onChange={(event) =>
